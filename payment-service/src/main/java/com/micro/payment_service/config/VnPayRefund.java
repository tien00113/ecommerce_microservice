...
public class VnPayRefund extends HttpServlet {
    ...
    public static String testrefund(){
        String hash_Data = String.join("|", "20240628789", "2.1.0", "refund", "8D21DT2V",
                "02", "20627350", "12300000", "14484019", "20240628165341",
                "nguyen", "20240628172008", "127.0.0.1", "12+1+1+2+1");
